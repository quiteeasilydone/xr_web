  ...
  Janus.init({
    ...
    callback: function () {
      ...
      $("#start").one("click", function () {
        ...
        myroom = document.getElementById("machineSelect").value;
        // Create session
        janus = new Janus({
          server: server,
            ...
            janus.attach({
              ...
              onlocaltrack: function (track, on) {
                ...
                if ($("#mute").length === 0) {
                  // Add a 'mute' button
                  $("#videolocal").append(
                    '<button class="btn btn-warning btn-sm bottom-left m-2" id="mute">Mute</button>'
                  );
                  $("#mute").click(toggleMute);
                  // Add an 'unpublish' button
                  $("#videolocal").append(
                    '<button class="btn btn-warning btn-sm bottom-right m-2" id="unpublish">Unpublish</button>'
                  );
  ...
  janus.attach({
    ...
    onremotetrack: function (track, mid, on, metadata) {
      ...
      if (track.kind === "audio") {
        ...
        $("#videoremote" + remoteFeed.rfindex).append(
          '<span class="badge bg-primary bottom-left m-3 hide" id="curres' +
            remoteFeed.rfindex +
            '"></span>' +
            '<span class="badge bg-info bottom-right m-3 hide" id="curbitrate' +
            remoteFeed.rfindex +
            '"></span>'
        );
        Janus.attachMediaStream(
  ...
  $("#remote" + index)
    ...
    .append(
      '<div id="simulcast' +
        ...
        '		<button id="sl' +
        index +
        '-2" type="button" class="btn btn-primary" data-bs-toggle="tooltip" title="Switch to higher quality">SL 2</button>' +
        '		<button id="sl' +
        index +
        '-1" type="button" class="btn btn-primary" data-bs-toggle="tooltip" title="Switch to normal quality">SL 1</button>' +
        '		<button id="sl' +
        index +
        '-0" type="button" class="btn btn-primary" data-bs-toggle="tooltip" title="Switch to lower quality">SL 0</button>' +
        "	</div>" +
        '	<div class="btn-group btn-group-xs d-flex hide" style="width: 100%">' +
        '		<button id="tl' +
        index +
        '-2" type="button" class="btn btn-primary" data-bs-toggle="tooltip" title="Cap to temporal layer 2">TL 2</button>' +
        '		<button id="tl' +
        index +
        '-1" type="button" class="btn btn-primary" data-bs-toggle="tooltip" title="Cap to temporal layer 1">TL 1</button>' +
        '		<button id="tl' +
        index +
        '-0" type="button" class="btn btn-primary" data-bs-toggle="tooltip" title="Cap to temporal layer 0">TL 0</button>' +
        "	</div>" +
        "</div>"
    );
